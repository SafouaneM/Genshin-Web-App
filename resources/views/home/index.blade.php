...
@section('video')
    <video class="animate-fade-in-down" src="{{asset('storage/video/pagebg.mp4')}}" muted loop autoplay></video>
@endsection
...
@section('content')
    ...
    <div style="background-image: url({{asset('storage/image/opacity_mondstadt.png')}})"
        ...
        <div class="grid grid-cols-2 p-5 mt-3 rounded-lg">
            <div class="text-lg font-bold text-center p-12 rounded-lg row-span-4">
                <img src="{{asset('storage/image/content.png')}}" class="" alt="">
            </div>

            <div
                class="bg-violet-500 hover:bg-violet-800 rounded overflow-hidden shadow-lg text-lg font-bold p-12 rounded-lg row-span-1">
                <h1 class="text-4xl text-cyan-400 ">Hi Traveler, </h1>
                <p class="text-cyan-200 p-2">Welcome to a Genshin Impact database full of information about your favorite characters,
                    locations, enemies and more...
                </p>
                <p class="text-cyan-200 p-2">If you create an account you can also make use of the online character
            ...
            <div
                class="mt-5 bg-violet-500 hover:bg-violet-800 rounded overflow-hidden shadow-lg text-lg font-bold p-12 rounded-lg row-span-1">
                <h1 class="text-4xl text-cyan-400 ">Features; </h1>
                <p class="text-cyan-200 p-2">Here's a list of feature's you'll unlock on our Genshin Database, after creating an account.
                </p>
                <ul class="list-roman text-cyan-200 p-9">
