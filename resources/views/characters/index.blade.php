...
<div class="grid gap-8 space-x-1 lg:grid-cols-5 p-12 px-10">
    ...
    <div class="px-4 py-4 bg-violet-300 border-2 border-violet-500 rounded-lg">
        <div class="flex flex-col items-center pb-8">
            ...
            {{---todo I think i can make this cleaner?--}}
                <span class="text-sm font-bold text-gray-500 dark:text-{{$element_color[$character->vision]}}">{{$character->vision}}</span>
                <div class="flex mt-4 space-x-3 lg:mt-6">
                <a href="characters/{{$character->id}}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Learn more</a>
