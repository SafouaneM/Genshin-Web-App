    ...
    <div class="grid gap-3 space-x-5 lg:grid-cols-4 p-12 px-10">
        ...
        <div class="container col-start-2 col-span-5 p-4 md:p-0">
            ...
            <div class="shadow-lg flex flex-wrap w-full lg:w-4/5">
                ...
                <!-- Card body -->
                <div class="w-full md:w-2/3" style="background-color:{{$element_color[$character->vision]}} ">
                    ...
                    <div class="h-full mx-auto px-6 md:px-0 md:pt-6 md:-ml-6 relative">
                        ...
                        <div
                            ...
                            <div class="w-full lg:w-1/5 lg:border-right lg:border-solid text-center md:text-left rounded-lg">
                            ...
                            <!-- Card description -->
                            <div class="w-full lg:w-3/5 lg:px-3 rounded-lg">
